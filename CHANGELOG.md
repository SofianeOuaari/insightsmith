...
- **knowledge**: Recipe books of worked answers, one per engine
...
- **engine**: Add pandas, and fix what a synthetic corpus found
...
- **engine**: Choose between Polars and FireDucks for generated code
...
- **viz,execution**: Stop charts and results asserting what the data does not say

## [0.6.2] - 2026-08-29

### Bug fixes

- **viz,coder**: Say what actually went wrong
